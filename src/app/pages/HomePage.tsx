          ...
          <div className="space-y-7 max-w-[680px] pl-4 lg:pl-10">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a
                ...
                className="border-2 border-white text-white px-8 py-3 rounded-full hover:bg-white hover:text-[#232D4B] transition-colors"
              >
                View Resume
              </a>
            </div>
      ...
      <section id="about" className="bg-white py-[100px]">
        <div className="max-w-[760px] mx-auto px-8 text-center">
          ...
          <p className="text-[#444444] text-[17px] leading-[1.8] mb-10">
            I’m a student at the University of Virginia studying Computer Science with a minor in Engineering Business.
            I’m especially interested in building software that uses human-centered design to solve real, everyday problems.
            At HoosHack 2026, I developed a dorm designer that uses 3D room modeling to help first-year students visualize shared dorm spaces before move-in.
            The tool lets students plan layouts, understand space constraints, and decide what to bring, making the transition to college a little less stressful.
            Experiences like this have shaped my interest in software engineering that combines technical depth with practical, user-focused design.
          </p>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 rounded-2xl overflow-hidden shadow-xl h-[380px]">
              <div className="bg-[#232D4B] p-12 flex flex-col justify-center">
                <h3 className="text-white font-bold text-[26px] mb-4">
                  DormDraft - 3D Dorm Designer
                </h3>
                <p className="text-[#B0B8C9] text-[15px] leading-[1.7] mb-6">
                  An interactive 3D dorm planner that lets students visualize their room, arrange furniture to scale, and plan layouts before arriving on campus.
                </p>
                <Link
              ...
              <div
                ...
                onMouseEnter={() => setIsDormDraftHovered(true)}
                onMouseLeave={() => setIsDormDraftHovered(false)}
                >
                {isDormDraftHovered ? (
                    <video
                    src="/projects/dormdraft/dormdraft-arrange.mov"
                    ...
                    <img
                    src="/projects/dormdraft/dormdraft-poster.png"
                    alt="DormDraft preview"
                    className="w-full h-full object-cover"
                    />
                )}
               </div>
